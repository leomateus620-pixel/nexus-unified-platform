...
Acesso: **Mapas 3D → Escolher unidade 3D → Moega 3 e coberturas**. Visualização dedicada em `/mapas-3d/trevisan`, isolada de outros projetos. Catálogo em `/mapas-3d/unidades`; o mapa existente do 3Tentos permanece em `/mapas-3d`.
